...
const Activity = () => {
  ...
  return (
    <div className="bg-background text-on-surface font-body selection:bg-primary/30 selection:text-primary">
      {/* SideNavBar */}
      <aside className="h-screen w-64 fixed left-0 top-0 bg-background flex flex-col py-8 px-4 z-50 shadow-[0_0_15px_rgba(0,208,156,0.1)]">
        <div className="mb-10 px-2">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-primary rounded-sm flex items-center justify-center">
              <span className="material-symbols-outlined text-on-primary font-bold">lock</span>
            </div>
            <div>
              <h1 className="text-xl font-black text-primary tracking-tighter uppercase leading-none">
                Janus Protocol
              </h1>
        ...
        <nav className="flex-1 space-y-1">
          <a
            href="#"
            className="flex items-center gap-3 px-3 py-2.5 rounded-sm text-on-surface-variant hover:text-primary transition-all hover:bg-surface-container hover:shadow-[0_0_10px_rgba(0,208,156,0.2)] group transition-all duration-200 ease-in-out hover:translate-x-1"
          >
          ...
          >
            ...
            <span className="font-medium tracking-tight">AI Agent</span>
          </a>
          <a
            href="#"
            className="flex items-center gap-3 px-3 py-2.5 rounded-sm text-on-surface-variant hover:text-primary transition-all hover:bg-surface-container hover:shadow-[0_0_10px_rgba(0,208,156,0.2)] group transition-all duration-200 ease-in-out hover:translate-x-1"
          >
            ...
            <span className="font-medium tracking-tight">Policies</span>
          </a>
          <a
            href="#"
            className="flex items-center gap-3 px-3 py-2.5 rounded-sm text-primary bg-surface-container font-bold border-r-2 border-primary group transition-all duration-200 ease-in-out hover:translate-x-1"
          >
            <span className="material-symbols-outlined">history</span>
            <span className="font-medium tracking-tight">Activity</span>
          </a>
          <a
            href="#"
            className="flex items-center gap-3 px-3 py-2.5 rounded-sm text-on-surface-variant hover:text-primary transition-all hover:bg-surface-container hover:shadow-[0_0_10px_rgba(0,208,156,0.2)] group transition-all duration-200 ease-in-out hover:translate-x-1"
          >
            ...
            <span className="font-medium tracking-tight">Security</span>
          </a>
          <a
            href="#"
            className="flex items-center gap-3 px-3 py-2.5 rounded-sm text-on-surface-variant hover:text-primary transition-all hover:bg-surface-container hover:shadow-[0_0_10px_rgba(0,208,156,0.2)] group transition-all duration-200 ease-in-out hover:translate-x-1"
          >
            ...
            <span className="font-medium tracking-tight">ZK Passport</span>
          </a>
          <a
            href="#"
            className="flex items-center gap-3 px-3 py-2.5 rounded-sm text-on-surface-variant hover:text-primary transition-all hover:bg-surface-container hover:shadow-[0_0_10px_rgba(0,208,156,0.2)] group transition-all duration-200 ease-in-out hover:translate-x-1"
        ...
        <div className="mt-auto">
          <button className="w-full py-3 bg-gradient-to-br from-primary to-primary-container text-on-primary font-bold text-xs tracking-widest uppercase rounded-sm hover:opacity-90 transition-opacity active:scale-95 duration-200">
            Connect Wallet
          </button>
        </div>
      </aside>
      ...
      {/* TopAppBar */}
      <header className="fixed top-0 right-0 w-[calc(100%-16rem)] h-16 z-40 bg-background/80 backdrop-blur-md flex justify-between items-center px-8 font-mono text-sm">
      ...
      <main className="ml-64 pt-24 px-10 pb-12 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-8 items-end">
          ...
          <div className="md:col-span-2">
            ...
            <select
              className="w-full bg-surface-container-low border-none focus:ring-1 focus:ring-primary/40 rounded-sm text-sm h-11 appearance-none"
              value={statusFilter}
